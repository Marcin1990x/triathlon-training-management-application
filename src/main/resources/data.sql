...
INSERT INTO application_user (id, username, password, coach_id, email_address) VALUES (10, 'marcin', '$2y$12$oRRbkNfwuR8ug4MlzH5FOeui.//1mkd.RsOAJMbykTSupVy.x/vb2', 10, 'marcin@marcin')
INSERT INTO roles (id, role, user_id) VALUES (10, 'USER', 10)
...
INSERT INTO stage (id, sequence , training_plan_id, description, stage_type, heart_rate, distance_in_meters, time_in_seconds, pace_in_seconds_per_km) VALUES (11, 1, 14, 'test stage1', 'RUN', 10, 10, 10, 12)
INSERT INTO stage (id, sequence , training_plan_id, description, stage_type, heart_rate, distance_in_meters, time_in_seconds, pace_in_seconds_per_km) VALUES (12, 2, 14, 'test stage2', 'RUN', 10, 10, 10, 12)